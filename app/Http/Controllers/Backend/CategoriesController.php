...
class CategoriesController extends BackendController
{
    ...
    public function store(Requests\CategoryStoreRequest $request)
    {
        ...
        return redirect('dashboard/categories')->with('message', 'New category was created');
    }
    ...
    public function update(Requests\CategoryUpdateRequest $request, $id)
    {
        ...
        return redirect('dashboard/categories')->with('message', 'Category was updated');
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function destroy(Requests\CategoryDestroyRequest $reqeuest, $id)
    {
        $category = Category::findOrFail($id);
        Post::withTrashed()->where('category_id', $id)->update(['category_id' => config('cms.default_category_id')]);
        $category->delete(); 
        
        return redirect('dashboard/categories')->with('message', 'Category was deleted');
    }
}
